...
namespace Names
{
    public class CinemaRating
    {
        ...
        {
            int[] aud = new int[] { 25, 30, 40, 50, 60, 70, 80 }; //настраиваемый список возрастных рейтингов
        ...
        {
            string[] labels = new string[aud.Length + 1];
            ...
            {
                labels[i] = String.Format("{0}-{1}", aud[i - 1], aud[i] - 1);
            }
            return labels;
        }
        ...
        {
            double[] values = new double[aud.Length + 1];
